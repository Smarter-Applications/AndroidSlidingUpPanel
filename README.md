Fork of Android Sliding Up Panel
=========================

This is a fork of the upstream library from Umano to make tweaks since this is no longer in active development.
The tweaks applied here are the following...

- Disable click to close independently of disabling the drag
...
* Include `am.smarter.slidinguppanel.SlidingUpPanelLayout` as the root element in your activity layout.
...
* The main layout should have the width & height set to `match_parent`.
...
```xml
<am.smarter.slidinguppanel.SlidingUpPanelLayout
